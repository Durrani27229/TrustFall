...
class AddContactInner extends StatefulWidget {
  const AddContactInner({super.key});

  @override
  State<AddContactInner> createState() => _AddContactInnerState();
}

class _AddContactInnerState extends State<AddContactInner> {
